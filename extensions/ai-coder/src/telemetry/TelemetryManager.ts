...
export class TelemetryManager {
  ...
  public async initialize(context: vscode.ExtensionContext): Promise<void> {
    ...
    try {
      ...
      Logger.error('Failed to initialize TelemetryManager', error instanceof Error ? error : new Error(String(error)));
      throw error;
    }
  }
  ...
  public async dispose(): Promise<void> {
    try {
      ...
      Logger.error('Error disposing TelemetryManager', error instanceof Error ? error : new Error(String(error)));
    }
  }
}
