 ...
 * @param {string} workspaceFolder The workspace folder
...
export class FileMetadataStore {
   ...
   * @param {FileMetadata} metadata The file metadata to save
   * @param {string} workspaceFolder The workspace folder containing the file
  ...
  public static async saveFileMetadata(
    ...
    const workspaceMetadata = extensionContext.globalState.get<{ lastSync: number }>(workspaceKey, { lastSync: 0 });
   ...
   * @returns {Promise<FileMetadataTable | undefined>} The file metadata or undefined if not found
   */
   ...
   * @returns {Promise<FileMetadataTable[]>} Array of file metadata
   * @private
   */
   ...
   * @param {string} workspaceFolder The workspace folder
   * @returns {Promise<FileMetadataTable[]>} Array of file metadata for the workspace folder
   */
   ...
   * @param {string} filePath The path of the file
   * @param {string} currentMD5 The current MD5 hash of the file
   * @param {string} workspaceFolder The workspace folder containing the file
   ...
   * @param {string} workspaceFolder The workspace folder
   * @returns {Promise<number>} The last sync timestamp
   */
